...
- Release workflow opts into Node.js 24 for JavaScript actions via `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24=true`, ahead of the GitHub Actions Node.js 20 deprecation (forced default on 2026-06-02, removal on 2026-09-16).
